...
This directory stores the durable artifacts that back non-trivial changes.
...
- `intents/`
  why a change exists
- `research/`
  options, tradeoffs, sources, and recommendation
- `specs/`
  concrete behavior and acceptance shape
- `validations/`
  what was actually checked and what remains uncertain

## Current Records

- `intents/context-handoff-file.md`
- `intents/engineering-os-bootstrap.md`
...
- `intents/trial-build-system.md`
- `intents/ui-experience-bible.md`
- `intents/vendor-dashboard-task-flow.md`
- `specs/context-handoff-file.md`
- `specs/engineering-os-bootstrap.md`
...
- `specs/trial-build-system.md`
- `specs/ui-experience-bible.md`
- `specs/vendor-dashboard-task-flow.md`
- `research/context-handoff-file.md`
- `research/engineering-os-bootstrap.md`
...
- `research/ui-experience-bible.md`
- `research/vendor-dashboard-task-flow.md`
- `validations/context-handoff-file.md`
- `validations/engineering-os-bootstrap.md`
...
- `validations/ui-experience-bible.md`
- `validations/vendor-dashboard-task-flow.md`
