...
export async function PatientSearchPage() {
  ...
  return (
    <main className="min-h-screen pb-20">
      <SearchHero />
      <section className="mx-auto flex max-w-[1280px] flex-col gap-10 px-4 py-10 sm:px-6 sm:py-12 lg:gap-14 lg:px-8 lg:py-16">
        <SearchRouteIntro hospitalCount={hospitalCount} />
        <div
          id="hospital-compare"
          className="scroll-mt-24 rounded-[28px] bg-[linear-gradient(180deg,rgba(255,253,248,0.56),rgba(255,253,248,0.18))] p-1"
        >
